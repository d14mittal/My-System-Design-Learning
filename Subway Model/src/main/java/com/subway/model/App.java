...
//        List<String> scheduledTiming = subwayService.trainScheduler(new Station("Midland", false, Arrays.asList("blue"), Arrays.asList("west")));
//
//         for(String schedule: scheduledTiming)
//            System.out.println(schedule);

        String nextArrivalTime = subwayService.arrivalTimeForNextTrain(new Station("Midland", Arrays.asList("blue")), "north", "08:00:00");
